...
<nav class="z-1 navbar navbar-expand-lg navbar-dark ">
   <div class="container">
   ...
   <div class="container">
      <div class="row align-items-center">
         ...
         <div class="col-md-7 p-4">
            ...
            <h1 class="tagline mb-3">Do some amazing things with me</h1>
            <div class="sub-judul">
            ...
            <a href="/download" class="btn btn-warning mt-4 mb-5"><i class="fa-solid fa-download"></i> Download CV</a>
         </div>
      </div>
   </div>
</div>
      ...
      <div class="row justify-content-between">
         <div class="col-md-6 p-5">
            ...
            <div class="sosial-media">
               <a href="https://www.instagram.com/jajaroyana4/">
                  <i class="fa-brands fa-square-instagram"></i>
               </a>
               <a href="https://github.com/jajaroyana505">
